...
We can estimate a smooth periodic curve of photoperiod (hours of daylight) by
averaging day-of-year across multiple years, and then fitting simple sinusoidal
functions using nonlinear least squares.
...
Custom models are also supported by passing a named list of formula and start:
